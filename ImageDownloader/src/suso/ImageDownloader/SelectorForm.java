...
public class SelectorForm extends JPanel implements ActionListener {
	static String fuskatorStr = "Fuskator";
	static String postYourGirlsWSStr = "PostYourGirlsWS";
	...
	public SelectorForm() {
		...
		group.add(fuskatorBtn);
		group.add(postyourgwsBtn);
		...
		picture = new JLabel(createImageIcon("images/" + fuskatorStr + ".gif"));
